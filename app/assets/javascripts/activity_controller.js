$(document).ready(function(){
  ...
  navigator.geolocation.getCurrentPosition(function(position){activityController.getFourSqaureData(position);})
});
...
ActivityController.prototype = {
  ...
  getFourSqaureData: function (position) {
    var lat_and_long = position.coords.latitude.toString().substr(0,10) + "," + position.coords.longitude.toString().substr(0,10)
    var jhqxr = $.ajax({
      url: "activities/whatever",
      type: 'get',
      data: {lat_and_long: lat_and_long}
